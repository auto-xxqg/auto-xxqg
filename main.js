            ...
            <viewpager id="viewpager">
                ...
                <frame>
                    ...
                    <vertical>
                        ...
                        <button text="-------函数名执行的配置-------" style="Widget.AppCompat.Button.Borderless.Colored" w="*"/>
                        <horizontal>
                            <text textSize="15sp" marginLeft="15" textColor="black" text="函数名:" />
                            <input id="zhixing" w="80" text="" />
                        </horizontal>
                        <horizontal>
                            <text textSize="15sp" marginLeft="15" textColor="black" text="第一个参数(不用则留空):" />
                            <input id="can1" w="80" text="null" />
                        </horizontal>
                        <horizontal>
                            <text textSize="15sp" marginLeft="15" textColor="black" text="第二个参数(不用则留空):" />
                            <input id="can2" w="80" text="null" />
                        </horizontal>
                        <horizontal>
                            <text textSize="15sp" marginLeft="15" textColor="black" text="第三个参数(不用则留空):" />
                            <input id="can3" w="80" text="null" />
                        </horizontal>
                    </vertical>
                    </ScrollView>
                </frame>
                ...
                <frame>
                    <vertical>
                        ...
                        <text text="官方网站：http://xzy.9gz.xyz/" />
                    </vertical>
                </frame>
            </viewpager>
        </vertical>
...
ui.webview.loadUrl("http://xzy.9gz.xyz/");
...
ui.zx.click(function () {//挑战答题
    ...
    thread = threads.start(function () {
        start_app();
        var ff = ui.zhixing.getText();
        var can1 = ui.can1.getText();
        var can2 = ui.can2.getText();
        var can3 = ui.can3.getText();
        funcrun(ff, can1, can2, can3);
         threads.shutDownAll();
         console.hide();
         engines.stopAll();
         exit();
...
function funcrun(ff, can1, can2, can3){
    switch(ff){
        case "getTodayDateString":
            getTodayDateString();
            break;
        case "dateToString":
            dateToString(can1, can2, can3);
            break;
        case "main":
            main();
            break;
        ...
        case "articleStudy2":
            ...
            break;
        case "article_timing":
            article_timing(can1, can2);
            break;
        case "videoStudy_news":
            videoStudy_news();
            break;
        case "video_timing_news":
            video_timing_news(can1, can2);
            break;
        case "listenToRadio":
            listenToRadio();
            break;
        case "radio_timing":
            radio_timing(can1, can2);
            break;
        case "stopRadio":
            stopRadio();
            break;
        case "videoStudy_bailing":
            videoStudy_bailing(can1, can2);
            break;
        case "video_timing_bailing":
            video_timing_bailing(can1, can2);
            break;
        case "CollectAndShare":
            CollectAndShare(can1);
            break;
        case "Comment":
            Comment(can1);
            break;
        ...
        case "sub2":
            sub2();
            break;
        case "getYestardayDateString":
            getYestardayDateString();
            break;
        case "zsyQuestion":
            zsyQuestion();
            break;
        case "SRQuestion":
            SRQuestion();
            break;
        case "zsyQuestionLoop":
            zsyQuestionLoop();
            break;
        case "zsyQuestionLoop1":
            zsyQuestionLoop1();
            break;
        case "challengeQuestion":
            challengeQuestion();
            break;
        case "challengeQuestionLoop":
            challengeQuestionLoop(can1);
            break;
        case "dailyQuestion":
            dailyQuestion();
            break;
        ...
        case "specialQuestion":
            ...
            break;
        case "drawfloaty":
            drawfloaty(can1, can2);
            break;
        case "dailyQuestionLoop":
            dailyQuestionLoop();
            break;
        case "getFitbQuestion":
            getFitbQuestion();
            break;
        case "getChoiceQuestion":
            getChoiceQuestion();
            break;
        case "getTipsStr":
            getTipsStr();
            break;
        case "getAnswerFromTips":
            getAnswerFromTips(can1, can2);
            break;
        case "clickByTips":
            clickByTips(can1);
            break;
        ...
        case "indexFromChar":
            ...
            break;
        case "checkAndUpdate":
            checkAndUpdate(can1, can2, can3);
            break;
        case "judge_tiku_existence":
            judge_tiku_existence();
            break;
        case "getAnswer":
            getAnswer(can1, can2);
            break;
        ...
        case "updateTikunet":
            updateTikunet();
            break;
        case "CreateAndInsert":
            CreateAndInsert(can1);
            break;
    }
}
...
/*
 * @description: 答题更新题库
 * @param: question, answer, ansTiku
 * @return: true, false
*/

function cUpdateTiku(question, answer, ansTiku){
    if (ansTiku == "") { //题库为空则插入正确答案                
        var sql = "INSERT INTO tiku VALUES ('" + question + "','" + correctAns + "','')";
    } else { //更新题库答案
        var sql = "UPDATE tiku SET answer='" + correctAns + "' WHERE question LIKE '" + question + "'";
